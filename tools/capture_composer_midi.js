...
//
//   node tools/capture_composer_midi.js [--score piece-septet] [--server http://localhost:5300] [--fps 60] [--out midi/<score>.capture.json]
//
...
async function capture({ score = 'piece-septet', server = 'http://localhost:5300', fps = 60, log = console.log } = {}) {
...
if (require.main === module) {
  ...
  capture({ score, server: arg('server', 'http://localhost:5300'), fps: +arg('fps', 60) }).then(r => {
