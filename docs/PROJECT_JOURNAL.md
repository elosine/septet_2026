...
|---|---|---|---|
| **N1** | **► PLAN 2i sitting A** — ~~step 1 go-to-time + HOME~~ BUILT 2026-09-14 (§516; his try owed) → **step 2 the D49 audit** (verdicts → fixes; the out-of-range census done, §507) | **Fable** (verdicts) → Opus (fixes) | no (switch model) |
