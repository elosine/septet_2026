...
### STATE — 2026-09-16 (session 13), Fable 5.1; PLAN 2i.8 DONE (§531 · §536) — ► PLAN 2j THE PROOFING PASS (his eye, all parts; the notes collected, fixed at the end) — then SITTING F
...
**The next concrete step — PLAN 2j, THE PROOFING PASS (opened 2026-09-16, §537):** he proofs the notation part by part; **every note he gives goes
into PLAN 2j's list verbatim the moment it is said**, with the AI's reading of what the fix takes (looked up, marked, kept separate); **nothing is
fixed until he says the pass is done** — then all the fixes at once, in the save (his tab, or a script through the note card's own paths so a
strike's captured note follows its technique) → Save → R → his eye on each spot again. Only THEN sitting F, so the re-render carries the fixes.
First note: flute 59.55, the tongue ram dropped to `ord` (PLAN 2j.1).

**Then — SITTING F, step 9 THE AUDIO RE-RENDER (PLAN 2i.9, `docs/RENDER.md`):** the render is behind the save (M2 swap · bcl slap ·
...
**Resume reads:** this §2 · **PLAN 2j (the list)** · for F afterwards: `docs/RENDER.md` §1–§4 · PLAN 2i.9–2i.10 · RUNNING_LOG §453 (the first render, the numbers to compare against).
...
| **N3f** | **► PLAN 2j THE PROOFING PASS** (his eye, all parts, opened 2026-09-16, §537) — his notes collected in PLAN 2j verbatim as given, the AI's reading beside each; **fixed all together when he says the pass is done** (the save → R → his eye), BEFORE F so the re-render carries them. Note 1: flute 59.55, the tongue ram dropped to `ord` · note 2: "sempre secco" to the top, 0.15 right of the cut edge (§539–§540) · note 3: the piano's section-2 velocities to their D50 marks — 29 of 44 off-band (§544) · note 4: the piano's 2-3-4 at 611 → 42 pairs · 17 fours from 611.50 · the last note its own GC, his (c) recommended; the other triples his ear (§545, CN-87) — all five ruled: 2+1 everywhere but the piano · note 5: every strike in the six parts percussive outside the morph/surge windows — 14 offenders in section 1, listed (§546); Va/Vc jeté, the trills by env · note 6: the violin's morph dynamics — the page's MIDI is the known gap (velocity 100), the render's capture follows the curve on rotating channels; his ear on ♪ render owed (§547) | Fable collects · Opus fixes | no |
| **N3g** | **PLAN 2k — the bass clarinet in C: the transposing-instrument mechanism** (D55, §541–§542; after 2j, before 2b) — the pitch form per realization: the presentation score and the full ensemble rehearsal score in C (bass clef); the sectional, individual and part versions in B♭ treble; one registry override per realization at layout, both forms tested, the front-matter line; standing mandate M5 for every later version | Opus (the plan is written) | no |
