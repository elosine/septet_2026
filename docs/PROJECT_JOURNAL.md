...
| **N3** | **► sitting C** — step 4 the cross-staff group (2g.1), alone · **sitting D** — steps 5–6 the groups and `--pairs` (2g.2 · 2g.4 · 2g.5, D51) · **sitting E** — steps 7–8 the page rule (first: align `dynamicBands` to the eight-step scale, §520) + the surge device (CN-83 · CN-84) · **sitting F** — steps 9–10 re-render, demo video | Opus (Fable for 8's design) | **yes — wrap on Opus: `/checkpoint` · `/clear` · `/postclear`**; fresh session each |
