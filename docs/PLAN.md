...
- **2i — Section 3 notated: the strikes, the groups, the crescendos, the dynamics** — `planned 2026-09-14 (RUNNING_LOG §505–§511; the top line his: "top line good")` — **Result when done:**
  ...
  10. **The demo video** — `► NEXT · sitting F` (`tools/export_video.js`; PLAN 2b's sync proof as #4's PHASE 5; the cover title *Scattered Substance* tentative, CN-64 — his word first). **His shape (2026-09-16, RUNNING_LOG §556–§557):** the wide shot with close-ups, *"a new random selection for the close up sections and incorporating the transitions we used in the tuba video"*. **The top line (his "good run thru as much as you can independantly"):**
      ...
      3. **The cut** — the septet's sections in the cut tool, a few fresh seeds drawn against them, his pick. `scanned 2026-09-16 (§559): 300 seeds; 53 and 72 give two close-ups in every section, 4/4 — seed 53 recommended · HIS PICK OWED`
      4. **The transitions** — the 5-frame cross-dissolve at each cut, checked on septet frames. `checked 2026-09-16 (§560): two 5.5 s clips at seed 53's cuts, the blend over frames 81–85 measured · his eye on the clips owed`
