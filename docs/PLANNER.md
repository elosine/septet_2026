...
**NOW ✦** 2026-09-17 (session 15, Opus) — the demo video ✓ · the performance instructions drafted and copy-edited (`docs/notation_instructions/index.html`; RUNNING_LOG §565–§604) · the Bloom practice videos online, linked, archived (PLAN 2h.7 done, §595–§602). **► PLAN 2b IS CLOSED (§606–§618). The print score is approved and archived:** `print/score/approved/2026-09-17/` — 71 pages on A3 (68 of music), five gates green, his *"ok print score good"*. The page edges are a rule now (D59): a page owns [cut, next cut), 14 532 point items each drawn exactly once, 1304 arcs whole, 484 curves none from a neighbour, 19 pages ragged at most 18 % of the width (his "a"). **His application is compiled too** — `docs/application/Tempus-Lab2026-application-JYang.pdf`, 5 pages; one required checkbox still unticked, flagged to him. **► NOW: nothing of 2b remains — the four items that are his since §605, then PLAN 3 the performance score; 2c parts only if selected.** Deadline 2026-10-15. Settled: the title *Scattered Substance* · no section marks · one PDF · the ruler kept · 10.3 s/page · the ragged right edge. Pending him: his eye on the 2b.7 re-render.
