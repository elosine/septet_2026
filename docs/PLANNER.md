...
spec written; step 0's formula file rejected on hearing; the model moves to piece #2's human-sampled timing — his three trill sample files + a speed-indexed ingestion, options in RUNNING_LOG §100, his call; then the curve test; phase 1 on his go); the 0d bridge sweep of the strike techniques' ranges and lengths
