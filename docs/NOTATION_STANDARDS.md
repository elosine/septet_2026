...
| The `sfz` takes the tuba's below-chain and side-with-room rule (`dynMark: sfz`, `chainSide` unset); the `tr` = the technique-symbol slot above, 0.45 ss over the staff or the unit's top ink, centred on the head (`techSymbol: trill`, `techSymbolScale: 0.70`) | `devices.byEnv.trill` | §432 · §438 |
