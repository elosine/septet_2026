...
| **The piano's 44 notes in the morph section — DEFERRED (§476):** built after the morphs are done (PLAN 2h.5); the device chosen then — the section-1 strike device with "pizz." / "ord." marks was recommended (34 onsets, 32 plucked + 12 ordinary, ringing 4.5–7 s, one pair 0.19 s apart) | — | deferred |
